Generate and install the app icon for /tmp/sjnhome-go.
...
/tmp/sjnhome-go/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/sjnhome-go/app/src/main/res/drawable/icon.png`.
